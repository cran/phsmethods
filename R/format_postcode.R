...
#'
#' @description `format_postcode` takes a character string or vector of
...
#' }
#'
#' [UK government regulations](https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/283357/ILRSpecification2013_14Appendix_C_Dec2012_v1.pdf)
...
#' warning message - see **Value** section for more information.
#' @param format A character string denoting the desired output format. Valid
#' options are `pc7` and `pc8`. The default is `pc7`. See **Value**
...
#' are performed.
#'
#' @return When `format` is set equal to `pc7`, `format_postcode`
...
#'
#' When `format` is set equal to `pc8`, `format_postcode` returns
